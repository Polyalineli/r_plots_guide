...
plot(mtcars$mpg)
```
<br>На диаграмме рассеяния каждому наблюдению (или элементарной единице набора данных) соответствует точка, координаты которой равны значениям двух каких-то параметров этого наблюдения.
<br>
...
### Grammar of graphics
.pull-left[
Подход к построению графиков в ggplot2 принципиально отличается от обычных типов графиков. Набор правил для построения графиков, а не конкретные виды графиков. Опирается на книгу граммар оф графикс
]
.pull-right[
<img src="img/gg.jfif">
]
...
.bottom[https://twitter.com/tanya_shapiro/status/1576935152575340544]
---
# ggplot2
